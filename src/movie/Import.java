...
public class Import extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Please enter the information in the file from which you want to import the information");

        jLabel2.setText("the path:..\\Movie\\import/import.txt");
    ...
    // show a joptionpane dialog using showMessageDialog
        ...
        try {
            a = new mainClass();
              if("false".equals(a.Import())){
                JOptionPane.showMessageDialog(frame,"Please check the data of the import file");
              
              }
             
             else if(a.Import().equals("true")){
               JOptionPane.showMessageDialog(frame,"operation accomplished successfully");
